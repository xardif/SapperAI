...
public class SapperLogic {
	...
	public SapperLogic(Field field) {
		setField(field);
		this.turnPosition = 2;	//zakï¿½adamy, ï¿½e po starcie programu saper jest zwrï¿½cony do gï¿½ry
	}
	...
	public int movesCount(Field to) {
		int xDiff = this.field.getXPosition() - to.getXPosition();	//jeï¿½eli minus to w dï¿½
		int yDiff = this.field.getYPosition() - to.getYPosition();	//jeï¿½eli minus to w prawo
